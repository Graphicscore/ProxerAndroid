...
inline fun Observer<*>.checkMainThread(): Boolean = if (Looper.myLooper() != Looper.getMainLooper()) {
...
): Disposable = this.subscribe(onSuccess) {
    Timber.e(it)
    onError(it)
}
...
inline fun <T> Observable<T>.subscribeAndLogErrors(): Disposable? = this.subscribe(
    {},
    {
        Timber.e(it)
    },
...
inline fun <T> Flowable<T>.subscribeAndLogErrors(): Disposable? = this.subscribe(
    {},
    {
        Timber.e(it)
    },
...
inline fun <T> Single<T>.subscribeAndLogErrors(): Disposable = this.subscribe(
    {},
    {
        Timber.e(it)
    },
...
inline fun Completable.subscribeAndLogErrors(noinline onSuccess: () -> Unit): Disposable = this.subscribe(onSuccess) {
    Timber.e(it)
}

inline fun Completable.subscribeAndLogErrors(): Disposable = this.subscribe(
    {},
    {
        Timber.e(it)
    },
...
inline fun <T> Maybe<T>.subscribeAndLogErrors(noinline onSuccess: (T) -> Unit): Disposable = this.subscribe(onSuccess) {
    Timber.e(it)
}

inline fun <T> Maybe<T>.subscribeAndLogErrors(): Disposable = this.subscribe(
    {},
    {
        Timber.e(it)
    },
...
inline fun <T> ObservableSubscribeProxy<T>.subscribeAndLogErrors(): Disposable = this.subscribe(
    {},
    {
        Timber.e(it)
    },
...
inline fun <T> FlowableSubscribeProxy<T>.subscribeAndLogErrors(): Disposable = this.subscribe(
    {},
    {
        Timber.e(it)
    },
...
inline fun <T> SingleSubscribeProxy<T>.subscribeAndLogErrors(): Disposable = this.subscribe(
    {},
    {
        Timber.e(it)
    },
...
inline fun CompletableSubscribeProxy.subscribeAndLogErrors(): Disposable = this.subscribe(
    {},
    {
        Timber.e(it)
    },
