...
object Mp4UploadTrustManagerWorkaround {
    fun create(): X509TrustManager = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
        createSdk24()
    } else {
        createSdk21()
    }

    private fun createSdk21(): X509TrustManager = object : X509TrustManager {
    ...
    private fun createSdk24(): X509ExtendedTrustManager = object : X509ExtendedTrustManager() {
