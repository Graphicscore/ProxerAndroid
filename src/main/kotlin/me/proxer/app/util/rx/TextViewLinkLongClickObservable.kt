 ...
 * @author Ruben Gees
 */
class TextViewLinkLongClickObservable(private val view: TextView, private val handled: (String) -> Boolean) :
    Observable<String>() {
    ...
    internal class Listener(
        ...
        override fun onLongClick(textView: TextView, url: String): Boolean = if (!isDisposed) {
            try {
