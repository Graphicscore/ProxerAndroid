...
class EditCommentFragment : BaseContentFragment<LocalComment>(R.layout.fragment_edit_comment) {
    ...
    private fun initUI() {
        ...
        bold.setIconicsImage(CommunityMaterial.Icon2.cmd_format_bold, 32)
        italic.setIconicsImage(CommunityMaterial.Icon2.cmd_format_italic, 32)
        underlined.setIconicsImage(CommunityMaterial.Icon2.cmd_format_underline, 32)
        strikethrough.setIconicsImage(CommunityMaterial.Icon2.cmd_format_strikethrough_variant, 32)
        size.setIconicsImage(CommunityMaterial.Icon2.cmd_format_size, 32)
        color.setIconicsImage(CommunityMaterial.Icon2.cmd_format_color_fill, 32)
        left.setIconicsImage(CommunityMaterial.Icon2.cmd_format_align_left, 32)
        center.setIconicsImage(CommunityMaterial.Icon2.cmd_format_align_center, 32)
        right.setIconicsImage(CommunityMaterial.Icon2.cmd_format_align_right, 32)
