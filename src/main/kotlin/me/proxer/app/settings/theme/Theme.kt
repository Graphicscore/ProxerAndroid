...
enum class Theme(
    ...
    @ColorInt
    fun primaryColor(context: Context): Int = context.resolveColor(R.attr.colorPrimary, nativeTheme(context))

    @ColorInt
    fun secondaryColor(context: Context): Int = context.resolveColor(R.attr.colorSecondary, nativeTheme(context))

    @ColorInt
    fun colorOnSecondary(context: Context): Int = context.resolveColor(R.attr.colorOnSecondary, nativeTheme(context))

    private fun nativeTheme(context: Context) =
