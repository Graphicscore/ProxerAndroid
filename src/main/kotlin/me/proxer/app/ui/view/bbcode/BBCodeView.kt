    ...
    init {
        ...
        if (attrs != null) {
            context.withStyledAttributes(attrs, R.styleable.BBCodeView) {
                textSize =
                    getDimension(R.styleable.BBCodeView_textSize, Float.MIN_VALUE)
                        .let { if (it == Float.MIN_VALUE) null else it.toInt() }

                textAppearance =
                    getResourceId(R.styleable.BBCodeView_textAppearance, Int.MIN_VALUE)
                        .let { if (it == Int.MIN_VALUE) null else it }

                textColor =
                    getColor(R.styleable.BBCodeView_textColor, Int.MIN_VALUE)
                        .let { if (it == Int.MIN_VALUE) null else it }

                spoilerTextColor =
                    getColor(R.styleable.BBCodeView_spoilerTextColor, Int.MIN_VALUE)
                        .let { if (it == Int.MIN_VALUE) null else it }
